  ...
  const catFeatures = [
    {
      ...
      unique: "Unlike homogeneous AOPs (e.g., Fenton or UV/H₂O₂) that rely on bulk chemical mixing or energy-intensive UV lamps, CAT is heterogeneous and catalyst-driven, offering reusability and efficiency without external energy sources like electrochemical oxidation, avoiding issues like short oxidant half-life or pH sensitivity.",
